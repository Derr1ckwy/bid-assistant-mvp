...
class Settings:
    ...
    llm_compact_threshold_chars: int = int(os.getenv("LLM_COMPACT_THRESHOLD_CHARS", "60000"))
    llm_compact_chunk_chars: int = int(os.getenv("LLM_COMPACT_CHUNK_CHARS", "8000"))
    llm_compact_max_items: int = int(os.getenv("LLM_COMPACT_MAX_ITEMS", "2"))
    llm_compact_max_output_tokens: int = int(os.getenv("LLM_COMPACT_MAX_OUTPUT_TOKENS", "512"))
